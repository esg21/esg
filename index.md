...
| <img width="400">CVE |Vendor/Product |Vulnerability Name| <img width="250">Date Added to List | <img width="250">Due Date |<img width="410">Notes 
------------------------------------|---------------|------------------|-------------------|--------------|----------------------------------
...
CVE-2022-42475 | Fortinet FortiOS | SSLVPN      | 2022-12-13 | 2022-12-15 | [Official Advisories](https://www.fortiguard.com/psirt/FG-IR-22-398) <br> 如果無法更新: <br> *如果非必需，禁用VPN-SSL功能 <br> *觀察日誌並驗證未經授權訪問<br> *設置條件存取，如GeoIP限制您的曝光程度 |
